...
<html lang="en">
	...
	#tidio-chat-iframe{inset:auto 9px 0 auto!important}
        #page-topbar {
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box" >
                            <a href="{{ url('/home') }}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/images/kinneypayfavicon.png') }}" alt="" height="70px" width="70px" />
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/images/kinneypaylogo.png')}}" alt="" height="70px" width="180px" />
                                </span>
                            </a>

                            <a href="{{ url('/home') }}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/images/kinney.ico') }}" alt="" height="70px" width="70px" />
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/images/kinney_logo_new.png') }}" alt="" height="70px" width="180px" />
                                </span>
                            </a>
                        </div>
...
<!--                         <form class="app-search d-none d-lg-block">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            	...
                            	<span style="color:#fff;font-size:20px;font-weight:600"> {{auth()->user()->name}} </span>
                                
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="{{ url('/Profile/'.auth()->user()->id) }}"><i class="mdi mdi-account-circle font-size-16 align-middle me-2 text-white"></i> <span>Profile</span></a>
                                ...
                                <a class="dropdown-item d-block" href="{{ url('/Profile/'.auth()->user()->id) }}"><!--span class="badge bg-success float-end">11</span--><i class="mdi mdi-wrench font-size-16 align-middle text-white me-2"></i> <span>Settings</span></a>
                                ...
                                <a class="dropdown-item text-white" onclick="return confirm('Are you sure want to Logout?')" href="{{ url('/logout') }}"><i class="mdi mdi-power font-size-16 align-middle me-2 text-white"></i> <span>Logout</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li>
                                        <a href="{{ url('/admin/recharge_form') }}"><i class="mdi mdi-cash-usd" style="color: white !important;"></i> Wallet Recharge</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/admin/recharge_history') }}"><i class="mdi mdi-cash-multiple" style="color: white !important;"></i> Recharge History</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    @if(auth()->user()->is_admin)
                                    <li>
                                        <a href="{{ url('/admin/profile/'.auth()->user()->id) }}"><i class="mdi mdi-export" style="color: white !important;"></i>Profile</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/admin/edit_profile/'.auth()->user()->id) }}"><i class="mdi mdi-message-draw" style="color: white !important;"></i>Edit Profile</a>
                                    </li>
                                    @endif
                                    @if(!auth()->user()->is_admin)
                                    <li>
                                        <a href="{{ url('/Profile/'.auth()->user()->id) }}"><i class="mdi mdi-export" style="color: white !important;"></i>Profile</a>
                                    </li>
                                    <li>
                            ...
                            @if(auth()->user()->is_admin)
                            <li>
                                <a href="{{ url('/admin/rewards') }}" class="waves-effect">
                                    <!--i class="mdi mdi-trophy-award" style="color: white !important;"></i-->
                                    <i class="mdi mdi-seal" style="color: white !important;"></i>
                                    <span>Rewards</span>
                                </a>
                            </li>
                            @endif
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    © 2021 Kinney Pay <span class="d-none d-sm-inline-block">- Crafted with <i class="mdi mdi-heart text-danger"></i> by Kinney Infotech.</span>
                </footer>
            </div>
        </div>
        <!-- Container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <img src="{{ asset('assets/images/App.png') }}" alt="" height="35px" />
                        <img src="{{ asset('assets/images/Play.png') }}" alt="" height="35px" />
                    </div>
                    ...
                    ©
                        <script>
                         ...
                         Kinney Pay <span class="d-none d-sm-inline-block">- Crafted with <i class="mdi mdi-heart"></i> By Kinney Infotech.</span>
                    </div>
                </div>
            </div>
