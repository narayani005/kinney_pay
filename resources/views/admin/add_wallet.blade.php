                    ...
                    <div style="min-height: 300px;">
                        ...
                        <form action="/credit-debit" method="POST">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="slef_account" id="slef_account" value="{{ auth()->user()->mobile }}" checked>
                                        <label class="form-check-label" for="slef_account">
                                            Self Account
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-3">
                                    <input class="form-control" name="score" type="text" id="amount" value="" Placeholder="Enter Amount" required/>
