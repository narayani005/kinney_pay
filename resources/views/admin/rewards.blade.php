                                        ...
                                        <div class="ptable-description">
                                            <div class="ptable-footer">
                                                <div class="ptable-action">
                                                    <button class="btn btn-primary" data-toggle="modal" data-target="#awardModal">Award #2</button>
                                                </div>
                                            </div>
                                            <ul>
                                ...
                                <div class="ptable-single">
                                    ...
                                    <div class="ptable-body">
                                        <div class="ptable-description">
                                            <div class="ptable-footer">
                                                <div class="ptable-action">
                                                    <button class="btn btn-primary" data-toggle="modal" data-target="#awardModal">Award #1</button>
                                                </div>
                                            </div>
                                            <ul>
                                                <li><b>Lorem ipsum dolor sit,amet, consectetur</b></li>
                                ...
                                <div class="ptable-single">
                                    ...
                                    <div class="ptable-body">
                                        <div class="ptable-description">
                                            <div class="ptable-footer">
                                                <div class="ptable-action">
                                                    <button class="btn btn-primary" data-toggle="modal" data-target="#awardModal">Award #3</button>
                                                </div>
                                            </div>
                                            <ul>
                                                <li><b>Lorem ipsum dolor sit,amet, consectetur</b></li>
