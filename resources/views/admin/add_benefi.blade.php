...
@section('page_name') Add Beneficiary @endsection @section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div style="min-height: 300px;">
                        ...
                        @endif
                        <form action="/benefi_submit" method="POST">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-3">
                                    <input class="form-control" name="benefi_mobile" id="mobile"  type="tel" value="" required/>
                                </div>
                            </div>
