		...
		<div class="container">
			<div class="appilo-menu clearfix">
				<nav class="navbar navbar-expand-lg navbar-custom navbar-light">
					...
					<a class="navbar-brand  mr-auto " href="http://kinneyinfo.com/">
						<img src="{{ asset('/kinnypay/assets/img/paylogo.png') }}" alt="Awesome Image" class="default-logo">
						<img src="{{ asset('/kinnypay/assets/img/wlogo.png') }}" alt="Awesome Image" class="stick-logo">
					</a>
					...
					<div class="collapse navbar-collapse navbar-nav" id="navbarToggler">
						<ul class="ml-auto">
							...
							<li><a class="nav-link" href="{{url('/#features')}}#features">Features</a></li>
